      ...
      <div className="flex items-center min-h-screen px-4 py-8">
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
          <div className="flex justify-end">
            <button
              className="p-2 text-gray-400 rounded-md hover:bg-gray-190"
              onClick={() => setCreateShipmentModel(false)}
            >
              <svg
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <p className="t 'text-[15px] text-gray-600">
              This is an example
            </p>
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="relative mt-3">
                <input
                  ...
                  outline-none border focus:border-indigo-600 shadow-sm roundedlg"
                  onChange={(e) =>
                    setShipment({
                      ...shipment,
              ...
              <button
                onClick={() => createItem()}
                className="block w-full mt-3 ру-3 px-4 font-medium text-sm text-center
